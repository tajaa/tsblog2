  ...
  return (
    <div className="min-h-[calc(100vh-130px)] py-2 container flex flex-col mt-12">
      ...
      >
        <input
          type="text"
          className="text-5xl focus-visible:outline-none bg-black rounded text-white font-mono"
          placeholder="Title"
          value={title}
        ...
        <textarea
          name="content"
          className="flex-1 bg-black text-white focus-visible:outline-none text-xl mt-2 px-1 py-1 rounded-md font-mono"
          value={content}
        ...
        <div className="self-start">
          ...
          <label className="text-slate-300 mb-3 mt-2">
        ...
        <button
          type="submit"
          className="w-fit-content font-mono bg-teal-500 text-black px-4 py-2 sm:px-6 sm:py-4 mt-6 border-2 rounded shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,1)]"
        >
          Create
        </button>
      </form>
